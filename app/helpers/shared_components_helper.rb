module SharedComponentsHelper
  ICONS = {
    ...
    credit_card: '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />',
    ...
    at_sign: '<circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8"/>',
    ...
    scan: '<path d="M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2"/><path d="M12 8v8M8.5 10.5 12 8l3.5 2.5"/>',
    trend_up: '<path d="m5 12 7-7 7 7"/><path d="M12 19V5"/>',
    trend_down: '<path d="m19 12-7 7-7-7"/><path d="M12 5v14"/>',
  ...
  def shared_icon(name, size: 16, stroke_width: 1.75)
